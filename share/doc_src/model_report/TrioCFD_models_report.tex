...
\usepackage{stackrel,mathrsfs,soul,tcolorbox,verbatimbox}
\usepackage{amsthm}
\usepackage{color}
\usepackage{xcolor}
\usepackage{colortbl}
...
\newcommand*\circled[1]{\tikz[baseline=(char.base)]{
        \node[shape=circle,fill=red!30,draw,inner sep=0.5pt] (char) {#1};}}
\newcommand*\circledb[1]{\tikz[baseline=(char.base)]{
        \node[shape=circle,fill=blue!30,draw,inner sep=0.5pt] (char) {#1};}}
\newcommand*\circledg[1]{\tikz[baseline=(char.base)]{
        \node[shape=circle,fill=green!30,draw,inner sep=0.5pt] (char) {#1};}}
...
\newcommand{\normal}{\vec{ n}}
\newcommand{\point}{x}
\newcommand{\uz}{\mathbf{u}_0}
\newcommand{\uo}{\mathbf{u}_1}
\newcommand{\uot}{{\tilde{\mathbf{u}}}_1}
\newcommand{\uzt}{{\tilde{\mathbf{u}}}_0}
\newcommand{\Tzt}{\tilde{T}_0}
\newcommand{\Tot}{\tilde{T}_1}
\newcommand{\Tzht}{\tilde{T}_{0,h}}
\newcommand{\Toht}{\tilde{T}_{1,h}}
\newcommand{\pzt}{\tilde{p}_0}
\newcommand{\pot}{\tilde{p}_1}
\newcommand{\pzht}{\tilde{p}_{0,h}}
\newcommand{\poht}{\tilde{p}_{1,h}}
\newcommand{\vvect}{\mathbf{v}}
\newcommand{\uvect}{\mathbf{u}}
\newcommand{\xvect}{\mathbf{x}}
\newcommand{\vect}{\mathbf{0}}
\newcommand{\nvect}{\mathbf{n}}
\newcommand{\bevect}{\bm{\beta}}
\newcommand{\tavect}{\bm{\tau}}
\newcommand{\nuvect}{\bm{\nu}}
\newcommand{\lavect}{\bm{\lambda}'}
\newcommand{\al}{\alpha}
\newcommand{\be}{\beta}
...
\def\lrbb#1{\left[ #1\right]}
\def\surf#1{\overline{#1}^{i}}
\def\inter#1{\overline{\overline{#1}}^{i}}
\def\spa#1{\langle#1\rangle}
\def\spak#1{\langle#1\rangle^k}
\def\phase#1{\overline{#1}^k}
...
\begin{flushright}\Ovalbox{\begin{minipage}{8cm} \begin{center} \vspace{0.4cm}\Large{DES/ISAS/DM2S/STMF/LDEL}\vspace{0.4cm}\end{center}\end{minipage}}\end{flushright}
...
\vspace{0.4cm}
\begin{center}
\includegraphics[scale=0.5]{../pictures/TrioCFD.png}
\hspace{0.4cm}
\includegraphics[scale=0.35]{../pictures/logo_DM2S.png}
\end{center}
\vspace{0.4cm}
...
v\codeVersion & \today & A. B du CLUZEAU & TrioCFD Team\\
              &        &   &\\
\hline
...
\multicolumn{2}{Sc|}{ } & \multicolumn{2}{Sc}{\large{\textbf{DES/ISAS/DM2S/STMF/LDEL/UD}} } \\
...
\input{./part42-FTD.tex}
\input{./part43-Phase_field.tex}
\input{./part44-IJK.tex}

\part{Fluid Structure Interaction Method}
\label{sec:ALE}
\normalsize \normalfont
\input{./part5-ALE.tex}
...
\bibliography{BibTeX_TrioCFD, 18-Stokes_bib, bibALE, bibCMFD, bibFTD, bibIJK, bibSENSITIVITY, bibAlgo_QC.bib}
