...
\usepackage{listings}
\usepackage{amsmath,amsthm,amssymb,amsfonts,stmaryrd,stackrel,mathrsfs,soul,tcolorbox,verbatimbox,textcomp}
%\usepackage{tabularx}
...
% maxnames=2,         % Les citations dans le texte avec \cite n'affiche que le nom du premier auteur et met un "et al.".n
...
\lstdefinestyle{mystyle}{
    ...
    morekeywords=[3]{VDF, PolyMAC_MPFA, taux_dissipation_turbulent, energie_cinetique_turbulente, criteres_convergence, evanescence, convection, diffusion, conditions_limites, initial_conditions, liquide_eau, boundary_conditions, sources, iter_min, seuil_convergence_implicite,solveur_pression,gaz_air,interface_eau_air},
...
\vspace{0.4cm}\\
\hspace{2.8cm}\LARGE{\textbf{TRUST-TrioCFD : Multiphase Module v\codeVersion}}}\end{center}
\vspace{0.3cm}
...
\hline
v\codeVersion & \today  & A DU CLUZEAU  & TrioCFD Team\\
             &          &               &  \\
\hline
...
\multicolumn{2}{c|}{ } & \multicolumn{2}{l}{\large{\textbf{DES/ISAS/DM2S/STMF/LDEL/UD}} } \\
...
\input{./Sections/Evanescence.tex}
\cleardoublepage
\input{./Sections/Timeschemes.tex}
\cleardoublepage
\input{./Sections/Spatialschemes.tex}
\cleardoublepage

% Physics
\input{./Sections/Physicalmodeling.tex}
\cleardoublepage
\input{./Sections/Turbulence.tex}
\cleardoublepage
\input{./Sections/Mixturemodeling.tex}
\cleardoublepage
%\input{./Sections/ConjugateHeatTransfer.tex}
%\cleardoublepage
\input{./Sections/Postprocessing.tex}
\cleardoublepage
