...
class run_IC_Velocity:

    def __init__(self,cross_sec):
        #cross_sec = "H" // cross_sec = "V"
    ...
    def execute(self):
        ...
        self.test_case = "Taylor/Velocity/Lid_v_"
        ...
        self.test_case = "/Velocity/Lid_driven_cavity_Poly_Chaos_"
...
class plot_case_IC_Velocity(run_IC_Velocity):
    ...
    def affichage_graph(self):
        ...
        match choix:
            ...
            case "1":
                ...
                ref= np.loadtxt(run_dir+"/"+'Ref_sens/velocity_H_x.txt', unpack=True, usecols=[1])
                t_ref= np.loadtxt(run_dir+"/"+'Ref_sens/velocity_H_x.txt', unpack=True, usecols=[0])
                fig, ax = plt.subplots()
